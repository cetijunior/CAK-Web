  ...
  return ( 
    <div style={{
      ...
      <div style={{
        ...
        opacity: isVisible ? 1 : 0,
        pointerEvents: isVisible ? 'auto' : 'none',
      }} className='md:mr-[40px] md:ml-[20px] mr-[30px] ml-[15px]'>
        {children}
